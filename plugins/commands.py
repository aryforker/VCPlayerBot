...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/the_aryana_py'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/aryforker/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/aryforker/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/the_aryana_py'),     
        ],
        [
